...
void tabulka(int riadky, int medzery, int tab, int slova){
	int i;
	int max = maximum(riadky, medzery, tab, slova);
	...
	printf("     Riadky	     Medzery       Tabelatory         Slova");
	
}

int maximum(int riadky, int medzery, int tab, int slova){
	int max = riadky;
...
int main() {
	...
	if(fr != NULL){
		...
		printf("\n\n");
		tabulka(pocet_riadkov, pocet_medzier, pocet_tabelatorov, pocet_slov);
	}else{
